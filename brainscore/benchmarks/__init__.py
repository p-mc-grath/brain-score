...
def _experimental_benchmark_pool():
    ...
    from brainscore.benchmarks.rajalingham2019 import Rajalingham2019DeficitPredictionTask, \
        Rajalingham2019DeficitPredictionObject, Rajalingham2019SpatialDeficits
